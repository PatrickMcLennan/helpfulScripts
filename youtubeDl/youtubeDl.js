...
const youtubeDl = (videoUrl, directory) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    script.on('error', (err) => logger_1.default(`There was an error exectuing youtube-dl on ${timeStamp_1.default()} -> ${videoUrl}, ${err}`, directory));
    return script.on('exit', (code, signal) => {
        if (code !== 0) {
            logger_1.default(`There was an error exectuing youtube-dl on ${timeStamp_1.default()} -> ${videoUrl}`, directory);
        }
    });
});
